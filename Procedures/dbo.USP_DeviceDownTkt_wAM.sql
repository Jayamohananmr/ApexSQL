...
Anamika Pandey
4rth May 2015
As per jira RMM-4235 (sub jira RMM-5053)Commented part related to Public IP's suppressed regid.
*/   
--------------------------------------------------------------------  
...
SET NOCOUNT ON
	...
	--WHERE R.SiteID BETWEEN @InStartSiteid AND @InEndSiteId  
	...
	WHERE RESTYPE=1 AND V.REGTYPE='MSMA' AND V.PARENTID IS NULL 
	AND (
