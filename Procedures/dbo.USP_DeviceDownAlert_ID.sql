...
CREATE PROCEDURE [dbo].[USP_DeviceDownAlert_ID]
@InMode VARCHAR(20),
@InRegID  BIGINT,
@InAlertID BIGINT,
...
EXEC [USP_DeviceDownAlert_ID] 'NewAlert',1,102,12345,1,@OutStatus OUTPUT
SELECT @OutStatus 
 
DECLARE @OutStatus INT
EXEC [USP_DeviceDownAlert_ID] 'AutoClose',1,102,12345,0,@OutStatus OUTPUT
SELECT @OutStatus 
